...
public class Crypto {
    ...
    public static String encryptString(String t, int sValue, int n)
    {
        ...
        temp = groupify(caesarify(t,sValue),n);
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to Project Crypto");
        ...
        //Part 3 - Code Groups
        System.out.print("Preffered size for code groups: ");
        ...
        String plainText = decryptString(codeGroupedString,shiftValue);
